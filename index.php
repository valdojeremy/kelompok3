...
<html lang="en">
  <head>
    ...
    <title> Sistem Informasi Akademik ARS University </title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>  
            &nbsp; <a href="index.p hp" class="fa fa-mortar-board fa-2x" style="color:#fff;"><span><font size="4.95" color="white" face="Helvetica Neue">APLIKASI AKADEMIK</font></span></a>
            </center>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="assets/images/me.jpg" alt="..." class="img-circle profile_img">
              </div>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/me.jpg" alt="">Valdo Jeremi
                  </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2020 Aplikasi Akademik : Kelompok 3
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
